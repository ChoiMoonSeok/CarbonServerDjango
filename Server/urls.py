...
urlpatterns = [
    ...
    path('Preview/<str:root>/<str:Department>/total', views.PreviewQuery.as_view(), name='get'),
    path('Preview/<str:root>/<str:Department>/', views.PreviewQuery.as_view(), name='post'),
]
